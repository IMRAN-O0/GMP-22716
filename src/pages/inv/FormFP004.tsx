    ...
    <div className="max-w-4xl mx-auto bg-white border border-slate-200 shadow-[0_1px_3px_rgba(0,0,0,0.05)] rounded-2xl overflow-hidden">
      ...
      <form className="p-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div>
            <label className="block text-[13px] font-semibold text-slate-600 mb-1">
              رقم الدفعة المرتجعة <span className="text-red-500">*</span>
            </label>
            <input
              type="text"
              required
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setFormData({ ...formData, returnedQuantity: e.target.value })
              }
              className="w-full border-slate-300 rounded-lg shadow-sm focus:border-sky-400 text-sm py-2"
            />
          </div>
          <div>
            <label className="block text-[13px] font-semibold text-slate-600 mb-1">
              حالة المنتج المرتجع <span className="text-red-500">*</span>
            </label>
            <select
              required
              ...
              className="w-full border-slate-300 rounded-lg shadow-sm focus:border-sky-400 text-sm py-2"
            >
              <option value="Intact">سليم (صالح للاستخدام)</option>
          ...
          <div className="md:col-span-2">
            <label className="block text-[13px] font-semibold text-slate-600 mb-1">
              الإجراء المتخذ (فحص جديد، إتلاف، إعادة تدوير...)
            </label>
            <textarea
              rows={2}
              required
