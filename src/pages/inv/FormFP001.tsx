      ...
      <form className="p-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div>
            ...
            <input
              type="text"
              list="production-orders-list-fp001"
              required
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setFormData({ ...formData, qcStatus: e.target.value })
              }
          ...
          <div>
            <label className="block text-[13px] font-semibold text-slate-600 mb-1">
              تاريخ الإطلاق <span className="text-red-500">*</span>
            </label>
            <input
              type="date"
              required
